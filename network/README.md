...
| SIEM | Lenovo ThinkPad | Wazuh SIEM + homelab management |
| Workstation | Lenovo Legion | Daily driver + attack platform |
...
| ThinkPad | 192.168.0.45 (static) | Wazuh SIEM |
...
- Set up Kali dual boot on Lenovo Legion
